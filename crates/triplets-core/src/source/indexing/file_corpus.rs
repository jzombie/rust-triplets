...
mod tests {
    ...
    fn file_corpus_groups_by_date_directory() {
        ...
        assert!(
            avg_pair_distance(&grouped_rel_paths) <= avg_pair_distance(&ungrouped_rel_paths) + 5.0,
