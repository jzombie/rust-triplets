// The unweighted batch-fetch convenience methods (`next_*_batch`, `next_*_batch_for_split`,
// `prefetch_*_batches`) are deprecated in favor of the `*_with_weights` variants. These tests
// intentionally exercise the unweighted path, so suppress the deprecation lint here.
#![allow(deprecated)]
...
impl RecipeSource {
    fn new(records: Vec<DataRecord>, recipes: Vec<TripletRecipe>) -> Self {
        Self {
            inner: InMemorySource::from_records("recipe_source", records),
    ...
    DataRecord {
        ...
        sections: vec![
            ...
            RecordSection {
                ...
                token_count: WhitespaceTokenizer.token_count(&"This is the introduction paragraph with enough words for sampling."),
            },
        ],
        meta_prefix: None,
        label: None,
    ...
    let record = DataRecord {
        ...
        sections: vec![RecordSection {
            ...
            sentences: vec!["one two three four five six seven eight nine ten".into()],
                token_count: WhitespaceTokenizer.token_count(&"one two three four five six seven eight nine ten"),
        }],
        meta_prefix: None,
        label: None,
    };
    ...
    let records = vec![
        ...
        DataRecord {
            ...
            sections: vec![RecordSection {
                ...
                token_count: WhitespaceTokenizer.token_count(&"alpha beta gamma delta epsilon zeta eta theta iota kappa"),
            }],
            meta_prefix: None,
            label: None,
        },
...
fn select_role_parallel_returns_none_when_all_pools_are_empty() {
    ...
    let empty_section_record = DataRecord {
        ...
        sections: vec![RecordSection {
            ...
            sentences: vec![],
            token_count: WhitespaceTokenizer.token_count("".into()),
        }],
        meta_prefix: None,
        label: None,
    };
    ...
    let mut record_b = DataRecord {
        ...
        sections: vec![RecordSection {
            ...
            sentences: vec!["word1 word2 word3 word4 word5 word6 word7 word8".into()],
                token_count: WhitespaceTokenizer.token_count(&"word1 word2 word3 word4 word5 word6 word7 word8"),
        }],
        meta_prefix: None,
        label: None,
    };
...
fn select_anchor_positive_parallel_returns_none_when_retries_exhausted() {
    ...
    let single_chunk_record = DataRecord {
        ...
        sections: vec![RecordSection {
            ...
            token_count: WhitespaceTokenizer.token_count("unique text word".into()),
        }],
        meta_prefix: None,
        label: None,
    };
    ...
    let record = DataRecord {
        ...
        sections: vec![
            ...
            RecordSection {
                ...
                token_count: WhitespaceTokenizer.token_count(&"context section body words more and more content"),
            },
        ],
        meta_prefix: None,
        label: None,
    ...
    let anchor = DataRecord {
        ...
        sections: vec![
            ...
            RecordSection {
                ...
                token_count: WhitespaceTokenizer.token_count(&"Context section text for negative selection"),
            },
        ],
        meta_prefix: None,
        label: None,
